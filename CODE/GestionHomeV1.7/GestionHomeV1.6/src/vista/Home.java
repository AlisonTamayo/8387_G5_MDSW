...
public class Home extends javax.swing.JFrame {
   ...
   int MouseX,MouseY;
    ...
    private void initComponents() {
        ...
        RegistroAlicuota = new javax.swing.JLabel();
        ...
        Button_Exit.setText("Cerrar Sesión");
        ...
        BarraLateral.add(Panel_Exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 190, 40));

        btnRegistrarCasas.setFont(new java.awt.Font("Roboto Light", 0, 14)); // NOI18N
        btnRegistrarCasas.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btnRegistrarCasas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BarraLateral.add(btnRegistrarCasas, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 210, -1));

        RegistroAlicuota.setFont(new java.awt.Font("Roboto Light", 0, 14)); // NOI18N
        RegistroAlicuota.setForeground(new java.awt.Color(255, 255, 255));
        RegistroAlicuota.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        RegistroAlicuota.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/detalles 24.png"))); // NOI18N
        RegistroAlicuota.setText("REGISTRO ALICUOTAS Y REPORTES");
        RegistroAlicuota.setToolTipText("");
        RegistroAlicuota.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        RegistroAlicuota.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        RegistroAlicuota.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        RegistroAlicuota.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                RegistroAlicuotaMouseClicked(evt);
            }
        });
        BarraLateral.add(RegistroAlicuota, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 270, 60));

        PanelPrincipal.add(BarraLateral, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 270, 600));
    ...
    private void Button_ExitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Button_ExitMouseClicked
        if(MouseEvent.BUTTON1 == evt.getButton()){
            int n=JOptionPane.showConfirmDialog(this,"¿Desea cerrar sesión?","Advertencia",JOptionPane.YES_NO_OPTION);
    ...
    private void RegistroAlicuotaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RegistroAlicuotaMouseClicked
        // TODO add your handling code here:
        new RegistroAlicuotas().setVisible(true);
    }//GEN-LAST:event_RegistroAlicuotaMouseClicked
    ...
    private javax.swing.JLabel RegistroAlicuota;
